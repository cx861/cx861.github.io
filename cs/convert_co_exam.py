"""Convert 计算机组成原理_常考题型与解法.md to computer-org-exam-types.html."""

import re

MD_PATH = r'C:\Users\陈鑫\Desktop\过程文档\文档\计算机组成原理_常考题型与解法.md'
OUTPUT_PATH = r'E:\coding\demo\docs\cs\computer-org-exam-types.html'
REF_PATH = r'E:\coding\demo\docs\cs\data-structure-exam-types.html'
...
def main():
    ...
    print(f'Tables: {len(tb)} OK')

    # Build full page from reference
    ...
    # Customize
    template_head = template_head.replace('数据结构', '计算机组成原理')
    template_head = re.sub(r'<h1>.*?</h1>', '<h1>⚙\uFE0F 计算机组成原理 常考题型与解法</h1>', template_head)
    template_head = re.sub(r'<div class="breadcrumb">.*?</div>',
        '<div class="breadcrumb"><a href="../index.html">首页</a> / <a href="../exam-types.html">常考题型及解法</a> / 计算机组成原理</div>',
        template_head)
    template_head = template_head.replace('🗃️', '⚙\uFE0F')
