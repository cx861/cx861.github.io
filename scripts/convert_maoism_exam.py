#!/usr/bin/env python3
"""将 02-毛中特常见题型.md 转换为 HTML 页面"""

import re
import os

INPUT = r"C:\Users\陈鑫\Desktop\知识库\政治\题型\02-毛中特常见题型.md"
OUTPUT = r"E:\coding\demo\docs\politics\maoism-exam-types.html"
    ...
    while idx < len(blockquote_lines):
        ...
        if line.startswith('<li>'):
            ...
            while idx < len(blockquote_lines) and blockquote_lines[idx].startswith('<li>'):
                processed.append(blockquote_lines[idx])
                idx += 1
            processed.append('</ul>')
        else:
...
page_title = title_match.group(1) if title_match else '毛中特常见题型'
...
<div class="mobile-menu" role="dialog" aria-label="导航菜单">
    ...
    <div class="page-header politics">
        <h1>📗 {page_title}</h1>
        <div class="breadcrumb"><a href="../index.html">首页</a> / <a href="../exam-types.html">常考题型及解法</a> / 毛中特</div>
    </div>
