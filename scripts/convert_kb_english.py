...
<head>
    ...
    <style>
        ...
        blockquote {{ border-left:4px solid var(--english); background:var(--english-bg); padding:12px 16px; margin:12px 0; border-radius:0 4px 4px 0; }}
...
# ===== 批量转换 =====
TASKS = [
    ("词汇.md", "vocabulary.html", "🔤", "考研英语词汇"),
    ("高分写作.md", "writing.html", "✍️", "考研英语高分写作"),
    ("真题方法篇.md", "methods.html", "💡", "考研英语真题方法篇"),
    ("真题语法篇.md", "grammar.html", "📐", "考研英语真题语法篇"),
    ("真题长难句篇.md", "sentence.html", "🔍", "考研英语真题长难句篇"),
]

BASE = r"C:\Users\陈鑫\Desktop\知识库\英语"
OUT = r"E:\coding\demo\docs\english"

os.makedirs(OUT, exist_ok=True)

for input_name, output_name, emoji, title in TASKS:
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"✅ {output_name}: {len(input_lines)}行 → {tables_n}T/{code_n}C/{bq_n}B")
